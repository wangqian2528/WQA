...
#ifndef _GUI_DISPLAY_1_RESOURCES_H_
#define _GUI_DISPLAY_1_RESOURCES_H_
...
#define GX_FONT_ID_MSYH16 4
#define GX_FONT_ID_MSYH32 5
#define DISPLAY_1_FONT_TABLE_SIZE 6

/* Pixelmap ID definitions                                                     */

#define GX_PIXELMAP_ID_DEV 5
#define GX_PIXELMAP_ID_HOME 6
#define GX_PIXELMAP_ID_TEST 7
#define GX_PIXELMAP_ID_TIME 8
#define GX_PIXELMAP_ID_WARNING 9
